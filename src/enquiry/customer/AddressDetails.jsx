    ...
    <div class="container mt-5">
        ...
        <div>
            ...
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="paddrAreaname" value={localValues.data.custAddr.paddr.areaname} onChange={(e) => handleInputChange("paddr","areaname",e)} />
            </div>
            <div className="mb-3">
                <label htmlFor="paddrCityname" className="form-label">City Name</label>
                <input type="text" className="form-control" id="paddrCityname" 
                    value={localValues.data.custAddr.paddr.cityname} onChange={(e) => handleInputChange("paddr","cityname",e)} />
            </div>
            <div className="mb-3">
                <label htmlFor="paddrDistrict" className="form-label">District</label>
                <input type="text" className="form-control" id="paddrDistrict" 
                    value={localValues.data.custAddr.paddr.district} onChange={(e) => handleInputChange("paddr","district",e)} />
            </div>
            <div className="mb-3">
                <label htmlFor="paddrState" className="form-label">State</label>
                <input type="text" className="form-control" id="paddrState" 
                    value={localValues.data.custAddr.paddr.state} onChange={(e) => handleInputChange("paddr","state",e)} />
            </div>
            <div className="mb-3">
                <label htmlFor="paddrPincode" className="form-label">Pincode</label>
                <input type="number" className="form-control" id="paddrPincode" 
                    value={localValues.data.custAddr.paddr.pincode} onChange={(e) => handleInputChange("paddr","pincode",e)} />
            </div>
            <div className="mb-3">
                ...
                <input type="number" className="form-control" id="paddrHouseNumber" 
                    value={localValues.data.custAddr.paddr.houseNumber} onChange={(e) => handleInputChange("paddr","houseNumber",e)} />
            </div>
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="paddrStreetName" 
                    value={localValues.data.custAddr.paddr.streetName} onChange={(e) => handleInputChange("paddr","streetName",e)} />
            </div>
    ...
    Permanent Address Same As Local Address?
            ...
            <div className="mb-3">
                ...
                <input type="number" className="form-control" id="laddrHouseNumber" 
                    value={localValues.data.custAddr.laddr.houseNumber} onChange={(e) => handleInputChange("laddr","houseNumber",e)} />
            </div>
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="laddrStreetName" 
                    value={localValues.data.custAddr.laddr.streetName} onChange={(e) => handleInputChange("laddr","streetName",e)} />
            </div>
